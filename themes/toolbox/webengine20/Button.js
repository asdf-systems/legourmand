...
function asdf_Button(id, parent, positionX, positionY, bgColor, width , height, positionType, extra_css_class, initialShow, zIndex,image_normal, image_active, image_hover){
	this.mNormal = asdf_Engine.initParameter(image_normal, "Normal Image not set");
	this.mActive = asdf_Engine.initParameter(image_active, "Active Image not set - set to Image normal", image_normal);
	this.mHover = asdf_Engine.initParameter(image_active, "Hover Image not set - set to Image normal", image_normal);
...
asdf_Button.prototype.show = function(){
	...
	this.mImage = asdf_Engine.createDomObject(this, this.mId+ "_Image", "img", this.mType, this.mExtraClassCSS, this.mNormal);
